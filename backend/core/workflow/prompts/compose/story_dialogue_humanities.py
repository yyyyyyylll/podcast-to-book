"""
故事型 + 对话体 Compose Prompt（人文类）
适用于：有明确主客关系的人物故事/经历驱动型播客
典型场景：访谈艺术家/历史学者，主持人提问，嘉宾讲创作经历或人生故事
...
你正在将一期播客转写文本整理为一本访谈体书稿。这是一期以故事/经历为主线的访谈，内容可能围绕嘉宾自身的经历展开，也可能是嘉宾在讲述第三者（某个人物、某个组织/运动、某段历史）的故事。第一步需要规划章节结构。
